...
# Set up variables
password = ""
students = [("You", 1234,"123.7.49.29",90), ("Emily", 5678,"123.23.33.43",90), ("Mike", 9012,"1903.494.5202.6293",92), ("Sara", 3456,"123.4.25.6",95), ("David", 7890,"123.4.59.6",90),
            ("Anna", 2345,"123.4.5.6",90), ("Tom", 6789,"124.67.49.11",100), ("Julia", 123,"1101.428.295.286",92), ("Peter", 4567,"123.4.52.6",92), ("Mary", 8901,"123.4.53.6",90),
            ("Jake", 5432,"123.49.56.90",98), ("Olivia", 9876,"121.4.34.6",100), ("Nick", 3210,"1239.49.52.62",93), ("Eva", 7654,"123.4.52.634",97), ("Sam", 1098,"123.4.5.62",91)]
