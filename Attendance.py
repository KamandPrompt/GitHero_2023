...
# Set up variables
password = ""
students = [("You", 1234,"123.4.5.6",90), ("Emily", 5678,"123.4.5.6",90), ("Mike", 9012,"123.4.5.6",92), ("Sara", 3456,"123.4.5.6",95), ("David", 7890,"123.4.5.6",90),
            ("Anna", 2345,"123.4.5.6",90), ("Tom", 6789,"123.4.5.6",100), ("Julia", 123,"123.4.5.6",92), ("Peter", 4567,"123.4.5.6",92), ("Mary", 8901,"123.4.5.6",90),
